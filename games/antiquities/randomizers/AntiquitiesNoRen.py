...
PlatinumLove = Prosperity + ['Hinterlands: Fools Gold', 'Guilds: Masterpiece',
	...
	'Antiquities: Archaeologist']
#Ducat, Scepter, Spices
...
ShelterLove = DarkAges + ['Base: Remodel', 'Base: Mine', 'Intrigue: Replace',
	...
	'Nocturne: Cemetary + Haunted Mirror (Heirloom)',
        'Antiquities: Shipwreck', 'Antiquities: Graveyard',
        'Alchemy: Scrying Pool', 'Guilds: Journeyman', 'Antiquities: Stronghold']
	#Priest
...
BaneCards = ['Dark Ages: Vagrant', 'Dark Ages: Squire', 'Dark Ages: Beggar',
        ...
        'Empires: Encantress', 'Empires: Chariot Race',
        'Empires: Catapult/Rocks', 'Empires: Gladiator/Forture',
        'Antiquities: Discovery', 
        'Antiquities: Tomb Raider', 'Antiquities: Inscription',
        'Antiquities: Inspector', 'Antiquities: Gamepiece',
        'Antiquties: Miner', 'Antiquities: Shipwreck', 'Antiquities: Profiteer',
...
#Check for Spoils
includeSpoils = any((True for card in \
        ['Dark Ages: Bandit Camp', 'Dark Ages: Marauder', 'Dark Ages: Pillage'] \
        if card in resultList))

# add Prizes
includePrizes = 'Cornucopia: Tournament' in resultList

includeGhost = any((True for card in  \
        ['Nocturne: Cemetary + Haunted Mirror (Heirloom)', 'Nocturne: Exorcist'] \
        if card in resultList))
...
includeImp = any((True for card in ['Nocturne: Devils Workshop', \
        'Nocturne: Exorcist', 'Nocturne: Tormentor'] if card in resultList))

includeWish = any((True for card in ['Nocturne: Leprechaun', \
        'Nocturne: Secret Cave + Magic Lamp (Heirloom)'] if card in resultList))
