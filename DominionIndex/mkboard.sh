...
################################################################################
# This script is organized in different "modules". Except for the 'util' module,
# functions or global variables are prefixed with the name of the module.
#-----------.-------------------------------------------------------------------
# MODULE    | DESCRIPTION
#-----------+-------------------------------------------------------------------
# util      | misc. small utility functions
#-----------+-------------------------------------------------------------------
# index     | function utility to get and display indexes
#-----------+-------------------------------------------------------------------
# card      | functions to find or print cards (including "landscape cards")
#-----------+-------------------------------------------------------------------
...
#-----------'-------------------------------------------------------------------
#
# Modules may (or man not) have the following functions:
#----------.--------------------------------------------------------------------
